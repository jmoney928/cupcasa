...
<div style="font-family:sans-serif;max-width:600px;margin:0 auto;color:#1a1a1a;">
  <div style="background:#2C1A0E;padding:24px 32px;border-bottom:3px solid #C4874A;">
    <p style="color:#C4874A;font-size:11px;letter-spacing:2px;margin:0 0 4px;text-transform:uppercase;">Cupcasa</p>
  ...
  <div style="padding:32px;">
    ...
    ${message ? `<div style="margin-top:24px;padding:16px 20px;background:#FDF5EC;border-left:3px solid #C4874A;">
